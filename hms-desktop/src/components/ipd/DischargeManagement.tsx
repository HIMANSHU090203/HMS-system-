...
const DischargeManagement = ({ onBack, isAuthenticated, user }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      { style: { display: 'flex', gap: '8px', minHeight: 'calc(100vh - 100px)' } },
      ...
      React.createElement(
        ...
        React.createElement(
          'h3',
          { style: { marginTop: 0, marginBottom: '15px', fontSize: '16px', fontWeight: '600', color: '#000000', paddingBottom: '8px', borderBottom: '1px solid #C8C8C8' } },
          'Discharged Patients'
        ),
      ...
      selectedAdmission ? React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'h3',
            { style: { margin: 0, fontSize: '16px', fontWeight: '600', color: '#000000' } },
            `${selectedAdmission.patient?.name || 'Unknown'} - Discharge Summary`
          ),
          React.createElement(
            'div',
            { style: { fontSize: '13px', color: '#6B7280', marginTop: '5px' } },
