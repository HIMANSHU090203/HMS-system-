            ...
            React.createElement(
              ...
              ...inpatientBills.map((bill, idx) => {
                ...
                return React.createElement(
                  ...
                  React.createElement('td', { style: { padding: '12px' } }, formatCurrency(parseFloat(bill.roomCharges || 0))),
                  React.createElement('td', { style: { padding: '12px' } }, formatCurrency(parseFloat(bill.procedureCharges || 0))),
                  React.createElement('td', { style: { padding: '12px' } }, formatCurrency(parseFloat(bill.medicineCharges || 0))),
                  React.createElement('td', { style: { padding: '12px' } }, formatCurrency(parseFloat(bill.labCharges || 0))),
                  React.createElement('td', { style: { padding: '12px' } }, formatCurrency(parseFloat(bill.otherCharges || 0))),
                  React.createElement('td', { style: { padding: '12px', textAlign: 'right', fontWeight: 'bold' } }, formatCurrency(parseFloat(bill.totalAmount || 0))),
                  React.createElement(
                    'td',
                    { style: { padding: '12px' } },
                    React.createElement(
