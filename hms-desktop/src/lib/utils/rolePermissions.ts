...
export const rolePermissions = {
  [UserRole.ADMIN]: {
    modules: ['dashboard', 'patients', 'appointments', 'consultations', 'prescriptions', 'labTests', 'medicines', 'billing', 'users', 'configuration', 'ipd'],
    canManageUsers: true,
    canViewReports: true,
  ...
  [UserRole.RECEPTIONIST]: {
    modules: ['dashboard', 'patients', 'appointments', 'billing', 'ipd'],
    canManageUsers: false,
    canViewReports: true,
    canManageSystem: false,
    canAccessFinancials: true,
